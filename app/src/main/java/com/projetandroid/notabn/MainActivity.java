...
import static com.projetandroid.notabn.EditeNoteActivity.NOTE_EXTRA_Key;
...
public class MainActivity extends AppCompatActivity implements NoteEventListener, Drawer.OnDrawerItemClickListener {
    ...
    /**
     * Start EditeNoteActivity.class for Create New Note
     */
    ...
    private void onShareNote() {
        ...
        String notetext = note.getNoteText() + "\n\n Create on : " +
                NoteUtils.dateFromLong(note.getNoteData()) + "\n  By :" +
